...
export const bettingQueries = {
  ...
  listRounds: <TData = RoundsResponse,>({
    ...
    args,
    options,
  }: BettingListRoundsQuery<TData>): UseQueryOptions<
    RoundsResponse,
    Error,
    TData
  > => ({
...
export interface BettingBetsQuery<TData>
  extends BettingReactQuery<BetsResponse, TData> {
  args: {
    roundId: number
  }
}
export function useBettingBetsQuery<TData = BetsResponse>({
  ...
  return useQuery<BetsResponse, Error, TData>(
    bettingQueryKeys.bets(client?.moduleId, args),
    () =>
      client
        ? client.bets({
            roundId: args.roundId,
...
export interface BettingListOddsQuery<TData>
  extends BettingReactQuery<ListOddsResponse, TData> {
  args: {
    roundId: number
  }
}
export function useBettingListOddsQuery<TData = ListOddsResponse>({
  ...
  return useQuery<ListOddsResponse, Error, TData>(
    bettingQueryKeys.listOdds(client?.moduleId, args),
    () =>
      client
        ? client.listOdds({
            roundId: args.roundId,
...
export interface BettingListRoundsQuery<TData>
  extends BettingReactQuery<RoundsResponse, TData> {
  args: {
    limit?: number
    startAfter?: number
  }
...
export function useBettingListRoundsQuery<TData = RoundsResponse>({
  ...
  return useQuery<RoundsResponse, Error, TData>(
    bettingQueryKeys.listRounds(client?.moduleId, args),
    () =>
      client
        ? client.listRounds({
            limit: args.limit,
...
export interface BettingRoundQuery<TData>
  extends BettingReactQuery<RoundResponse, TData> {
  args: {
    roundId: number
  }
}
export function useBettingRoundQuery<TData = RoundResponse>({
  ...
  return useQuery<RoundResponse, Error, TData>(
    bettingQueryKeys.round(client?.moduleId, args),
    () =>
      client
        ? client.round({
            roundId: args.roundId,
...
export function useBettingCreateRoundMutation(
  options?: Omit<
    UseMutationOptions<ExecuteResult, Error, BettingCreateRoundMutation>,
    'mutationFn'
  >,
) {
