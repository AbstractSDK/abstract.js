...
import {
  BettingExecuteMsgBuilder,
  BettingQueryMsgBuilder,
} from './Betting.message-builder'
import {
  AccountId,
  AccountOdds,
  AccountTrace,
...
export class BettingAppClient
  extends BettingAppQueryClient
  implements IBettingAppClient
{
  accountClient: AbstractAccountClient
  ...
  createRound = async (
    ...
    return this._execute(
      BettingExecuteMsgBuilder.createRound(params),
      fee,
      memo,
      _funds,
    )
  ...
  register = async (
    ...
    return this._execute(
      BettingExecuteMsgBuilder.register(params),
      fee,
      memo,
      _funds,
    )
  ...
  updateAccounts = async (
    ...
    return this._execute(
      BettingExecuteMsgBuilder.updateAccounts(params),
      fee,
      memo,
      _funds,
    )
  ...
  placeBet = async (
    ...
    return this._execute(
      BettingExecuteMsgBuilder.placeBet(params),
      fee,
      memo,
      _funds,
    )
  ...
  distributeWinnings = async (
    ...
    return this._execute(
      BettingExecuteMsgBuilder.distributeWinnings(params),
      fee,
      memo,
      _funds,
    )
  ...
  closeRound = async (
    ...
    return this._execute(
      BettingExecuteMsgBuilder.closeRound(params),
      fee,
      memo,
      _funds,
    )
  ...
  updateConfig = async (
    ...
    return this._execute(
      BettingExecuteMsgBuilder.updateConfig(params),
      fee,
      memo,
      _funds,
    )
