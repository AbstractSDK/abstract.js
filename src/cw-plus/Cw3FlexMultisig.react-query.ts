...
export const cw3FlexMultisigQueryKeys = {
  ...
  address: (contractAddress: string | undefined) => ([{ ...cw3FlexMultisigQueryKeys.contract[0],
    address: contractAddress
  }] as const),
  threshold: (contractAddress: string | undefined, args?: Record<string, unknown>) => ([{ ...cw3FlexMultisigQueryKeys.address(contractAddress)[0],
    method: "threshold",
    args
  }] as const),
  proposal: (contractAddress: string | undefined, args?: Record<string, unknown>) => ([{ ...cw3FlexMultisigQueryKeys.address(contractAddress)[0],
    method: "proposal",
    args
  }] as const),
  listProposals: (contractAddress: string | undefined, args?: Record<string, unknown>) => ([{ ...cw3FlexMultisigQueryKeys.address(contractAddress)[0],
    method: "list_proposals",
    args
  }] as const),
  reverseProposals: (contractAddress: string | undefined, args?: Record<string, unknown>) => ([{ ...cw3FlexMultisigQueryKeys.address(contractAddress)[0],
    method: "reverse_proposals",
    args
  }] as const),
  vote: (contractAddress: string | undefined, args?: Record<string, unknown>) => ([{ ...cw3FlexMultisigQueryKeys.address(contractAddress)[0],
    method: "vote",
    args
  }] as const),
  listVotes: (contractAddress: string | undefined, args?: Record<string, unknown>) => ([{ ...cw3FlexMultisigQueryKeys.address(contractAddress)[0],
    method: "list_votes",
    args
  }] as const),
  voter: (contractAddress: string | undefined, args?: Record<string, unknown>) => ([{ ...cw3FlexMultisigQueryKeys.address(contractAddress)[0],
    method: "voter",
    args
  }] as const),
  listVoters: (contractAddress: string | undefined, args?: Record<string, unknown>) => ([{ ...cw3FlexMultisigQueryKeys.address(contractAddress)[0],
    method: "list_voters",
    args
  }] as const)
};
...
export function useCw3FlexMultisigListVotersQuery<TData = ListVotersResponse>({
  ...
  return useQuery<ListVotersResponse, Error, TData>(cw3FlexMultisigQueryKeys.listVoters(client?.contractAddress, args), () => client ? client.listVoters({
    limit: args.limit,
...
export function useCw3FlexMultisigVoterQuery<TData = VoterResponse>({
  ...
  return useQuery<VoterResponse, Error, TData>(cw3FlexMultisigQueryKeys.voter(client?.contractAddress, args), () => client ? client.voter({
...
export function useCw3FlexMultisigListVotesQuery<TData = ListVotesResponse>({
  ...
  return useQuery<ListVotesResponse, Error, TData>(cw3FlexMultisigQueryKeys.listVotes(client?.contractAddress, args), () => client ? client.listVotes({
    limit: args.limit,
...
export function useCw3FlexMultisigVoteQuery<TData = VoteResponse>({
  ...
  return useQuery<VoteResponse, Error, TData>(cw3FlexMultisigQueryKeys.vote(client?.contractAddress, args), () => client ? client.vote({
    proposalId: args.proposalId,
    voter: args.voter
  }) : Promise.reject(new Error("Invalid client")), { ...options,
    enabled: !!client && (options?.enabled != undefined ? options.enabled : true)
...
export function useCw3FlexMultisigReverseProposalsQuery<TData = ReverseProposalsResponse>({
  ...
  return useQuery<ReverseProposalsResponse, Error, TData>(cw3FlexMultisigQueryKeys.reverseProposals(client?.contractAddress, args), () => client ? client.reverseProposals({
    limit: args.limit,
...
export function useCw3FlexMultisigListProposalsQuery<TData = ListProposalsResponse>({
  ...
  return useQuery<ListProposalsResponse, Error, TData>(cw3FlexMultisigQueryKeys.listProposals(client?.contractAddress, args), () => client ? client.listProposals({
    limit: args.limit,
    startAfter: args.startAfter
  }) : Promise.reject(new Error("Invalid client")), { ...options,
    enabled: !!client && (options?.enabled != undefined ? options.enabled : true)
...
export function useCw3FlexMultisigProposalQuery<TData = ProposalResponse>({
  ...
  return useQuery<ProposalResponse, Error, TData>(cw3FlexMultisigQueryKeys.proposal(client?.contractAddress, args), () => client ? client.proposal({
    proposalId: args.proposalId
  }) : Promise.reject(new Error("Invalid client")), { ...options,
    enabled: !!client && (options?.enabled != undefined ? options.enabled : true)
  });
...
export function useCw3FlexMultisigThresholdQuery<TData = ThresholdResponse>({
  ...
  return useQuery<ThresholdResponse, Error, TData>(cw3FlexMultisigQueryKeys.threshold(client?.contractAddress), () => client ? client.threshold() : Promise.reject(new Error("Invalid client")), { ...options,
    enabled: !!client && (options?.enabled != undefined ? options.enabled : true)
  });
}
