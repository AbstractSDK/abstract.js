...
export const cw4GroupQueryKeys = {
  ...
  address: (contractAddress: string | undefined) => ([{ ...cw4GroupQueryKeys.contract[0],
    address: contractAddress
  }] as const),
  admin: (contractAddress: string | undefined, args?: Record<string, unknown>) => ([{ ...cw4GroupQueryKeys.address(contractAddress)[0],
    method: "admin",
    args
  }] as const),
  totalWeight: (contractAddress: string | undefined, args?: Record<string, unknown>) => ([{ ...cw4GroupQueryKeys.address(contractAddress)[0],
    method: "total_weight",
    args
  }] as const),
  listMembers: (contractAddress: string | undefined, args?: Record<string, unknown>) => ([{ ...cw4GroupQueryKeys.address(contractAddress)[0],
    method: "list_members",
    args
  }] as const),
  member: (contractAddress: string | undefined, args?: Record<string, unknown>) => ([{ ...cw4GroupQueryKeys.address(contractAddress)[0],
    method: "member",
    args
  }] as const),
  hooks: (contractAddress: string | undefined, args?: Record<string, unknown>) => ([{ ...cw4GroupQueryKeys.address(contractAddress)[0],
    method: "hooks",
    args
  }] as const)
};
...
export function useCw4GroupHooksQuery<TData = HooksResponse>({
  ...
  return useQuery<HooksResponse, Error, TData>(cw4GroupQueryKeys.hooks(client?.contractAddress), () => client ? client.hooks() : Promise.reject(new Error("Invalid client")), { ...options,
...
export function useCw4GroupListMembersQuery<TData = ListMembersResponse>({
  ...
  return useQuery<ListMembersResponse, Error, TData>(cw4GroupQueryKeys.listMembers(client?.contractAddress, args), () => client ? client.listMembers({
    limit: args.limit,
...
export function useCw4GroupTotalWeightQuery<TData = TotalWeightResponse>({
  ...
  return useQuery<TotalWeightResponse, Error, TData>(cw4GroupQueryKeys.totalWeight(client?.contractAddress), () => client ? client.totalWeight() : Promise.reject(new Error("Invalid client")), { ...options,
    enabled: !!client && (options?.enabled != undefined ? options.enabled : true)
  });
}
...
export function useCw4GroupAdminQuery<TData = AdminResponse>({
  ...
  return useQuery<AdminResponse, Error, TData>(cw4GroupQueryKeys.admin(client?.contractAddress), () => client ? client.admin() : Promise.reject(new Error("Invalid client")), { ...options,
    enabled: !!client && (options?.enabled != undefined ? options.enabled : true)
  });
}
