...
export const proxyQueryKeys = {
  ...
  address: (contractAddress: string | undefined) => ([{ ...proxyQueryKeys.contract[0],
    address: contractAddress
  }] as const),
  config: (contractAddress: string | undefined, args?: Record<string, unknown>) => ([{ ...proxyQueryKeys.address(contractAddress)[0],
    method: "config",
    args
  }] as const),
  totalValue: (contractAddress: string | undefined, args?: Record<string, unknown>) => ([{ ...proxyQueryKeys.address(contractAddress)[0],
    method: "total_value",
    args
  }] as const),
  holdingValue: (contractAddress: string | undefined, args?: Record<string, unknown>) => ([{ ...proxyQueryKeys.address(contractAddress)[0],
    method: "holding_value",
    args
  }] as const),
  holdingAmount: (contractAddress: string | undefined, args?: Record<string, unknown>) => ([{ ...proxyQueryKeys.address(contractAddress)[0],
    method: "holding_amount",
    args
  }] as const),
  assetConfig: (contractAddress: string | undefined, args?: Record<string, unknown>) => ([{ ...proxyQueryKeys.address(contractAddress)[0],
    method: "asset_config",
    args
  }] as const),
  assets: (contractAddress: string | undefined, args?: Record<string, unknown>) => ([{ ...proxyQueryKeys.address(contractAddress)[0],
    method: "assets",
    args
  }] as const),
  checkValidity: (contractAddress: string | undefined, args?: Record<string, unknown>) => ([{ ...proxyQueryKeys.address(contractAddress)[0],
    method: "check_validity",
    args
  }] as const),
  baseAsset: (contractAddress: string | undefined, args?: Record<string, unknown>) => ([{ ...proxyQueryKeys.address(contractAddress)[0],
    method: "base_asset",
    args
  }] as const)
};
...
export function useProxyBaseAssetQuery<TData = BaseAssetResponse>({
  ...
  return useQuery<BaseAssetResponse, Error, TData>(proxyQueryKeys.baseAsset(client?.contractAddress), () => client ? client.baseAsset() : Promise.reject(new Error("Invalid client")), { ...options,
...
export function useProxyCheckValidityQuery<TData = CheckValidityResponse>({
  ...
  return useQuery<CheckValidityResponse, Error, TData>(proxyQueryKeys.checkValidity(client?.contractAddress), () => client ? client.checkValidity() : Promise.reject(new Error("Invalid client")), { ...options,
    enabled: !!client && (options?.enabled != undefined ? options.enabled : true)
  });
}
...
export function useProxyAssetsQuery<TData = AssetsResponse>({
  ...
  return useQuery<AssetsResponse, Error, TData>(proxyQueryKeys.assets(client?.contractAddress, args), () => client ? client.assets({
...
export function useProxyAssetConfigQuery<TData = AssetConfigResponse>({
  ...
  return useQuery<AssetConfigResponse, Error, TData>(proxyQueryKeys.assetConfig(client?.contractAddress, args), () => client ? client.assetConfig({
...
export function useProxyHoldingAmountQuery<TData = HoldingAmountResponse>({
  ...
  return useQuery<HoldingAmountResponse, Error, TData>(proxyQueryKeys.holdingAmount(client?.contractAddress, args), () => client ? client.holdingAmount({
    identifier: args.identifier
  }) : Promise.reject(new Error("Invalid client")), { ...options,
    enabled: !!client && (options?.enabled != undefined ? options.enabled : true)
  });
...
export function useProxyHoldingValueQuery<TData = HoldingValueResponse>({
  ...
  return useQuery<HoldingValueResponse, Error, TData>(proxyQueryKeys.holdingValue(client?.contractAddress, args), () => client ? client.holdingValue({
    identifier: args.identifier
  }) : Promise.reject(new Error("Invalid client")), { ...options,
    enabled: !!client && (options?.enabled != undefined ? options.enabled : true)
  });
...
export function useProxyTotalValueQuery<TData = TotalValueResponse>({
  ...
  return useQuery<TotalValueResponse, Error, TData>(proxyQueryKeys.totalValue(client?.contractAddress), () => client ? client.totalValue() : Promise.reject(new Error("Invalid client")), { ...options,
    enabled: !!client && (options?.enabled != undefined ? options.enabled : true)
  });
}
...
export function useProxyConfigQuery<TData = ConfigResponse>({
  ...
  return useQuery<ConfigResponse, Error, TData>(proxyQueryKeys.config(client?.contractAddress), () => client ? client.config() : Promise.reject(new Error("Invalid client")), { ...options,
    enabled: !!client && (options?.enabled != undefined ? options.enabled : true)
  });
}
