...
export const managerQueryKeys = {
  ...
  address: (contractAddress: string | undefined) => ([{ ...managerQueryKeys.contract[0],
    address: contractAddress
  }] as const),
  moduleVersions: (contractAddress: string | undefined, args?: Record<string, unknown>) => ([{ ...managerQueryKeys.address(contractAddress)[0],
    method: "module_versions",
    args
  }] as const),
  moduleAddresses: (contractAddress: string | undefined, args?: Record<string, unknown>) => ([{ ...managerQueryKeys.address(contractAddress)[0],
    method: "module_addresses",
    args
  }] as const),
  moduleInfos: (contractAddress: string | undefined, args?: Record<string, unknown>) => ([{ ...managerQueryKeys.address(contractAddress)[0],
    method: "module_infos",
    args
  }] as const),
  config: (contractAddress: string | undefined, args?: Record<string, unknown>) => ([{ ...managerQueryKeys.address(contractAddress)[0],
    method: "config",
    args
  }] as const),
  info: (contractAddress: string | undefined, args?: Record<string, unknown>) => ([{ ...managerQueryKeys.address(contractAddress)[0],
    method: "info",
    args
  }] as const)
};
...
export function useManagerInfoQuery<TData = InfoResponse>({
  ...
  return useQuery<InfoResponse, Error, TData>(managerQueryKeys.info(client?.contractAddress), () => client ? client.info() : Promise.reject(new Error("Invalid client")), { ...options,
...
export function useManagerConfigQuery<TData = ConfigResponse>({
  ...
  return useQuery<ConfigResponse, Error, TData>(managerQueryKeys.config(client?.contractAddress), () => client ? client.config() : Promise.reject(new Error("Invalid client")), { ...options,
    enabled: !!client && (options?.enabled != undefined ? options.enabled : true)
  });
}
...
export function useManagerModuleInfosQuery<TData = ModuleInfosResponse>({
  ...
  return useQuery<ModuleInfosResponse, Error, TData>(managerQueryKeys.moduleInfos(client?.contractAddress, args), () => client ? client.moduleInfos({
...
export function useManagerModuleAddressesQuery<TData = ModuleAddressesResponse>({
  ...
  return useQuery<ModuleAddressesResponse, Error, TData>(managerQueryKeys.moduleAddresses(client?.contractAddress, args), () => client ? client.moduleAddresses({
    names: args.names
  }) : Promise.reject(new Error("Invalid client")), { ...options,
    enabled: !!client && (options?.enabled != undefined ? options.enabled : true)
  });
...
export function useManagerModuleVersionsQuery<TData = ModuleVersionsResponse>({
  ...
  return useQuery<ModuleVersionsResponse, Error, TData>(managerQueryKeys.moduleVersions(client?.contractAddress, args), () => client ? client.moduleVersions({
    names: args.names
  }) : Promise.reject(new Error("Invalid client")), { ...options,
    enabled: !!client && (options?.enabled != undefined ? options.enabled : true)
  });
...
export function useManagerSetRootMutation(options?: Omit<UseMutationOptions<ExecuteResult, Error, ManagerSetRootMutation>, "mutationFn">) {
  ...
  }) => client.setRoot(msg, fee, memo, funds), options);
}
