...
export interface Cw3FlexMultisigListVotersQuery
  extends Cw3FlexMultisigReactQuery<ListVotersResponse> {
  args: {
    limit?: number
    startAfter?: string
  }
...
export interface Cw3FlexMultisigListVotesQuery
  extends Cw3FlexMultisigReactQuery<ListVotesResponse> {
  args: {
    limit?: number
    proposalId: number
    startAfter?: string
...
export interface Cw3FlexMultisigReverseProposalsQuery
  extends Cw3FlexMultisigReactQuery<ReverseProposalsResponse> {
  args: {
    limit?: number
    startBefore?: number
  }
...
export interface Cw3FlexMultisigListProposalsQuery
  extends Cw3FlexMultisigReactQuery<ListProposalsResponse> {
  args: {
    limit?: number
    startAfter?: number
  }
...
export interface Cw3FlexMultisigThresholdQuery
  extends Cw3FlexMultisigReactQuery<ThresholdResponse> {}
