...
export function useManagerInfoQuery({ client, options }: ManagerInfoQuery) {
  return useQuery<InfoResponse, Error, unknown, (string | undefined)[]>(
...
export function useManagerModuleInfosQuery({ client, args, options }: ManagerModuleInfosQuery) {
  return useQuery<ModuleInfosResponse, Error, unknown, (string | undefined)[]>(
...
export function useManagerModuleAddressesQuery({
  ...
  return useQuery<ModuleAddressesResponse, Error, unknown, (string | undefined)[]>(
...
export function useManagerModuleVersionsQuery({
  ...
  return useQuery<ModuleVersionsResponse, Error, unknown, (string | undefined)[]>(
