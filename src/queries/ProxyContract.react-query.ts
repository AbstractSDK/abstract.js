...
export function useProxyCheckValidityQuery({ client, options }: ProxyCheckValidityQuery) {
  return useQuery<
    CheckValidityResponse | undefined,
    Error,
    CheckValidityResponse,
    (string | undefined)[]
  >(
    ['proxyCheckValidity', client?.contractAddress],
    () => (client ? client.checkValidity() : undefined),
...
export function useProxyProxyAssetsQuery({ client, args, options }: ProxyProxyAssetsQuery) {
  return useQuery<
    ProxyAssetsResponse | undefined,
    Error,
    ProxyAssetsResponse,
    (string | undefined)[]
  >(
    ['proxyProxyAssets', client?.contractAddress, JSON.stringify(args)],
    () =>
      client
        ? client.proxyAssets({
...
export function useProxyProxyAssetConfigQuery({
  ...
  return useQuery<
    ProxyAssetConfigResponse | undefined,
    Error,
    ProxyAssetConfigResponse,
    (string | undefined)[]
  >(
    ['proxyProxyAssetConfig', client?.contractAddress, JSON.stringify(args)],
    () =>
      client
...
export function useProxyHoldingAmountQuery({ client, args, options }: ProxyHoldingAmountQuery) {
  return useQuery<
    HoldingAmountResponse | undefined,
    Error,
    HoldingAmountResponse,
    (string | undefined)[]
  >(
    ['proxyHoldingAmount', client?.contractAddress, JSON.stringify(args)],
    () =>
      client
...
export function useProxyHoldingValueQuery({ client, args, options }: ProxyHoldingValueQuery) {
  return useQuery<
    HoldingValueResponse | undefined,
    Error,
    HoldingValueResponse,
    (string | undefined)[]
  >(
    ['proxyHoldingValue', client?.contractAddress, JSON.stringify(args)],
    () =>
      client
        ? client.holdingValue({
            identifier: args.identifier,
...
export function useProxyTotalValueQuery({ client, options }: ProxyTotalValueQuery) {
  ...
  >(
    ...
    () => (client ? client.totalValue() : undefined),
    { ...options, enabled: !!client && (options?.enabled != undefined ? options.enabled : true) }
  )
}
