...
export function useVersionControlQueryCodeIdQuery({
  ...
  return useQuery<QueryCodeIdResponse, Error, QueryCodeIdResponse, (string | undefined)[]>(
    ['versionControlQueryCodeId', client.contractAddress],
    () =>
      client.queryCodeId({
        module: args.module,
      }),
...
export function useVersionControlQueryOsAddressQuery({
  ...
  return useQuery<QueryOsAddressResponse, Error, QueryOsAddressResponse, (string | undefined)[]>(
    ['versionControlQueryOsAddress', client.contractAddress],
    () =>
      client.queryOsAddress({
        osId: args.osId,
      }),
    options
  )
...
export function useVersionControlQueryEnabledModulesQuery({
  ...
  return useQuery<
    ...
    (string | undefined)[]
  >(
    ['versionControlQueryEnabledModules', client.contractAddress],
    () =>
