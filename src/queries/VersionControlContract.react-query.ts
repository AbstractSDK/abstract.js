...
import { Addr, ApiAddressResponse, ContractVersion, ApiAddressesResponse, Uint64, CodeIdResponse, CodeIdsResponse, ConfigResponse, ExecuteMsg, InstantiateMsg, ModuleInfo, OsCoreResponse, Core, QueryMsg } from "../types/VersionControl.types";
...
export function useVersionControlApiAddressesQuery({
  ...
  return useQuery<ApiAddressesResponse, Error, ApiAddressesResponse, (string | undefined)[]>(["versionControlApiAddresses", client?.contractAddress, JSON.stringify(args)], () => client ? client.apiAddresses({
...
export function useVersionControlCodeIdsQuery({
  ...
  return useQuery<CodeIdsResponse, Error, CodeIdsResponse, (string | undefined)[]>(["versionControlCodeIds", client?.contractAddress, JSON.stringify(args)], () => client ? client.codeIds({
    iterLimit: args.iterLimit,
...
export function useVersionControlConfigQuery({
  ...
  return useQuery<ConfigResponse, Error, ConfigResponse, (string | undefined)[]>(["versionControlConfig", client?.contractAddress], () => client ? client.config() : Promise.reject(new Error("Invalid client")), { ...options,
    enabled: !!client && (options?.enabled != undefined ? options.enabled : true)
  });
}
...
export function useVersionControlApiAddressQuery({
  ...
  return useQuery<ApiAddressResponse, Error, ApiAddressResponse, (string | undefined)[]>(["versionControlApiAddress", client?.contractAddress, JSON.stringify(args)], () => client ? client.apiAddress({
    module: args.module
  }) : Promise.reject(new Error("Invalid client")), { ...options,
    enabled: !!client && (options?.enabled != undefined ? options.enabled : true)
  });
...
export function useVersionControlCodeIdQuery({
  ...
  return useQuery<CodeIdResponse, Error, CodeIdResponse, (string | undefined)[]>(["versionControlCodeId", client?.contractAddress, JSON.stringify(args)], () => client ? client.codeId({
    module: args.module
  }) : Promise.reject(new Error("Invalid client")), { ...options,
    enabled: !!client && (options?.enabled != undefined ? options.enabled : true)
  });
...
export function useVersionControlOsCoreQuery({
  ...
  return useQuery<OsCoreResponse, Error, OsCoreResponse, (string | undefined)[]>(["versionControlOsCore", client?.contractAddress, JSON.stringify(args)], () => client ? client.osCore({
    osId: args.osId
  }) : Promise.reject(new Error("Invalid client")), { ...options,
    enabled: !!client && (options?.enabled != undefined ? options.enabled : true)
  });
