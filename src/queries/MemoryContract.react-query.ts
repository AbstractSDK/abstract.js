...
import { AssetInfoBase_for_Addr, Addr, AssetListResponse, AssetsResponse, ContractListResponse, ContractsResponse, InstantiateMsg, QueryMsg } from "../contracts/MemoryContract";
