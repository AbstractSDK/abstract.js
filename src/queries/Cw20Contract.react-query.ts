...
export function useCw20DownloadLogoQuery({ client, options }: Cw20DownloadLogoQuery) {
  ...
  >(
    ...
    { ...options, enabled: !!client && options?.enabled }
  )
}
...
export interface Cw20MinterQuery {
  client?: Cw20QueryClient
  options?: Omit<
    UseQueryOptions<MinterResponse | undefined, Error, MinterResponse, (string | undefined)[]>,
    "'queryKey' | 'queryFn' | 'initialData'"
  > & {
    initialData?: undefined
  }
...
export interface Cw20BalanceQuery {
  client?: Cw20QueryClient
  options?: Omit<
    UseQueryOptions<BalanceResponse | undefined, Error, BalanceResponse, (string | undefined)[]>,
    "'queryKey' | 'queryFn' | 'initialData'"
  > & {
    initialData?: undefined
  }
...
export function useCw20UpdateMarketingMutation(
  ...
  return useMutation<ExecuteResult, Error, Cw20UpdateMarketingMutation>(
    ({ client, msg, args: { fee, memo, funds } }) => client.updateMarketing(msg, fee, memo, funds),
    options
  )
}
...
export function useCw20UpdateMinterMutation(
  ...
  return useMutation<ExecuteResult, Error, Cw20UpdateMinterMutation>(
    ({ client, msg, args: { fee, memo, funds } }) => client.updateMinter(msg, fee, memo, funds),
    options
  )
}
...
export function useCw20TransferFromMutation(
  ...
  return useMutation<ExecuteResult, Error, Cw20TransferFromMutation>(
    ({ client, msg, args: { fee, memo, funds } }) => client.transferFrom(msg, fee, memo, funds),
    options
  )
}
