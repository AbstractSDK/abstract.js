...
export const etfQueryKeys = {
  ...
  address: (contractAddress: string | undefined) => ([{ ...etfQueryKeys.contract[0],
    address: contractAddress
  }] as const),
  base: (contractAddress: string | undefined, args?: Record<string, unknown>) => ([{ ...etfQueryKeys.address(contractAddress)[0],
    method: "base",
    args
  }] as const),
  state: (contractAddress: string | undefined, args?: Record<string, unknown>) => ([{ ...etfQueryKeys.address(contractAddress)[0],
    method: "state",
    args
  }] as const)
};
...
export function useEtfStateQuery<TData = StateResponse>({
  ...
  return useQuery<StateResponse, Error, TData>(etfQueryKeys.state(client?.contractAddress), () => client ? client.state() : Promise.reject(new Error("Invalid client")), { ...options,
    enabled: !!client && (options?.enabled != undefined ? options.enabled : true)
  });
}
export interface EtfBaseQuery<TData> extends EtfReactQuery<BaseResponse, TData> {}
export function useEtfBaseQuery<TData = BaseResponse>({
  client,
  options
}: EtfBaseQuery<TData>) {
  return useQuery<BaseResponse, Error, TData>(etfQueryKeys.base(client?.contractAddress), () => client ? client.base() : Promise.reject(new Error("Invalid client")), { ...options,
    enabled: !!client && (options?.enabled != undefined ? options.enabled : true)
  });
}
...
export function useEtfImportMutation(options?: Omit<UseMutationOptions<ExecuteResult, Error, EtfImportMutation>, "mutationFn">) {
  ...
  }) => client.import(fee, memo, funds), options);
}
...
export function useEtfUpdatePoolMutation(options?: Omit<UseMutationOptions<ExecuteResult, Error, EtfUpdatePoolMutation>, "mutationFn">) {
  ...
  }) => client.updatePool(msg, fee, memo, funds), options);
}
...
export function useEtfReceiveMutation(options?: Omit<UseMutationOptions<ExecuteResult, Error, EtfReceiveMutation>, "mutationFn">) {
