...
import { BaseResponse, ExecuteMsg, RequestMsg, Uint128, BaseExecuteMsg, ApiRequestMsgForRequestMsg, QueryMsg } from "./Staking.types";
...
export function useStakingConfigureMutation(options?: Omit<UseMutationOptions<ExecuteResult, Error, StakingConfigureMutation>, "mutationFn">) {
...
export function useStakingRequestMutation(options?: Omit<UseMutationOptions<ExecuteResult, Error, StakingRequestMutation>, "mutationFn">) {
