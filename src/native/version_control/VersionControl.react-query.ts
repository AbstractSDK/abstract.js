...
export const versionControlQueryKeys = {
  ...
  codeId: (contractAddress: string | undefined, args?: Record<string, unknown>) =>
    [{ ...versionControlQueryKeys.address(contractAddress)[0], method: 'code_id', args }] as const,
  apiAddress: (contractAddress: string | undefined, args?: Record<string, unknown>) =>
    [
      { ...versionControlQueryKeys.address(contractAddress)[0], method: 'api_address', args },
    ] as const,
  config: (contractAddress: string | undefined, args?: Record<string, unknown>) =>
    [{ ...versionControlQueryKeys.address(contractAddress)[0], method: 'config', args }] as const,
  codeIds: (contractAddress: string | undefined, args?: Record<string, unknown>) =>
    [{ ...versionControlQueryKeys.address(contractAddress)[0], method: 'code_ids', args }] as const,
  apiAddresses: (contractAddress: string | undefined, args?: Record<string, unknown>) =>
    [
      { ...versionControlQueryKeys.address(contractAddress)[0], method: 'api_addresses', args },
    ] as const,
}
...
export function useVersionControlApiAddressesQuery<TData = ApiAddressesResponse>({
  ...
  return useQuery<ApiAddressesResponse, Error, TData>(
    versionControlQueryKeys.apiAddresses(client?.contractAddress, args),
    () =>
      client
        ? client.apiAddresses({
...
export function useVersionControlCodeIdsQuery<TData = CodeIdsResponse>({
  ...
  return useQuery<CodeIdsResponse, Error, TData>(
    versionControlQueryKeys.codeIds(client?.contractAddress, args),
    () =>
      client
        ? client.codeIds({
            pageSize: args.pageSize,
...
export function useVersionControlApiAddressQuery<TData = ApiAddressResponse>({
  ...
  return useQuery<ApiAddressResponse, Error, TData>(
    versionControlQueryKeys.apiAddress(client?.contractAddress, args),
    () =>
      client
        ? client.apiAddress({
            module: args.module,
...
export function useVersionControlCodeIdQuery<TData = CodeIdResponse>({
  ...
  return useQuery<CodeIdResponse, Error, TData>(
    versionControlQueryKeys.codeId(client?.contractAddress, args),
    () =>
      client
        ? client.codeId({
            module: args.module,
