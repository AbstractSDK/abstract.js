...
export const memoryQueryKeys = {
  ...
  address: (contractAddress: string | undefined) => ([{ ...memoryQueryKeys.contract[0],
    address: contractAddress
  }] as const),
  assets: (contractAddress: string | undefined, args?: Record<string, unknown>) => ([{ ...memoryQueryKeys.address(contractAddress)[0],
    method: "assets",
    args
  }] as const),
  contracts: (contractAddress: string | undefined, args?: Record<string, unknown>) => ([{ ...memoryQueryKeys.address(contractAddress)[0],
    method: "contracts",
    args
  }] as const),
  contractList: (contractAddress: string | undefined, args?: Record<string, unknown>) => ([{ ...memoryQueryKeys.address(contractAddress)[0],
    method: "contract_list",
    args
  }] as const),
  assetList: (contractAddress: string | undefined, args?: Record<string, unknown>) => ([{ ...memoryQueryKeys.address(contractAddress)[0],
    method: "asset_list",
    args
  }] as const)
};
...
export function useMemoryAssetListQuery<TData = AssetListResponse>({
  ...
  return useQuery<AssetListResponse, Error, TData>(memoryQueryKeys.assetList(client?.contractAddress, args), () => client ? client.assetList({
...
export function useMemoryContractListQuery<TData = ContractListResponse>({
  ...
  return useQuery<ContractListResponse, Error, TData>(memoryQueryKeys.contractList(client?.contractAddress, args), () => client ? client.contractList({
    pageSize: args.pageSize,
    pageToken: args.pageToken
  }) : Promise.reject(new Error("Invalid client")), { ...options,
    enabled: !!client && (options?.enabled != undefined ? options.enabled : true)
...
export function useMemoryContractsQuery<TData = ContractsResponse>({
  ...
  return useQuery<ContractsResponse, Error, TData>(memoryQueryKeys.contracts(client?.contractAddress, args), () => client ? client.contracts({
    names: args.names
  }) : Promise.reject(new Error("Invalid client")), { ...options,
    enabled: !!client && (options?.enabled != undefined ? options.enabled : true)
  });
...
export function useMemoryAssetsQuery<TData = AssetsResponse>({
  ...
  return useQuery<AssetsResponse, Error, TData>(memoryQueryKeys.assets(client?.contractAddress, args), () => client ? client.assets({
    names: args.names
  }) : Promise.reject(new Error("Invalid client")), { ...options,
    enabled: !!client && (options?.enabled != undefined ? options.enabled : true)
  });
...
export function useMemorySetAdminMutation(options?: Omit<UseMutationOptions<ExecuteResult, Error, MemorySetAdminMutation>, "mutationFn">) {
...
export function useMemoryUpdateAssetAddressesMutation(options?: Omit<UseMutationOptions<ExecuteResult, Error, MemoryUpdateAssetAddressesMutation>, "mutationFn">) {
  ...
  }) => client.updateAssetAddresses(msg, fee, memo, funds), options);
}
...
export function useMemoryUpdateContractAddressesMutation(options?: Omit<UseMutationOptions<ExecuteResult, Error, MemoryUpdateContractAddressesMutation>, "mutationFn">) {
  ...
  }) => client.updateContractAddresses(msg, fee, memo, funds), options);
}