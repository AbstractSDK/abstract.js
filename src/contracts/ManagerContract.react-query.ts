...
export function useManagerVaultAssetConfigQuery({
  ...
  return useQuery<
    ...
    (string | undefined)[]
  >(
    ['managerVaultAssetConfig', client.contractAddress],
    () =>
...
export function useManagerHoldingAmountQuery({ client, args, options }: ManagerHoldingAmountQuery) {
  return useQuery<HoldingAmountResponse, Error, HoldingAmountResponse, (string | undefined)[]>(
    ['managerHoldingAmount', client.contractAddress],
    () =>
...
export function useManagerHoldingValueQuery({ client, args, options }: ManagerHoldingValueQuery) {
  return useQuery<HoldingValueResponse, Error, HoldingValueResponse, (string | undefined)[]>(
    ['managerHoldingValue', client.contractAddress],
    () =>
      client.holdingValue({
        identifier: args.identifier,
      }),
...
export function useManagerTotalValueQuery({ client, options }: ManagerTotalValueQuery) {
  return useQuery<TotalValueResponse, Error, TotalValueResponse, (string | undefined)[]>(
    ['managerTotalValue', client.contractAddress],
    () => client.totalValue(),
    options
  )
}
