...
export declare type PoolIdBaseForString = {
    contract: string;
} | {
    id: number;
};
export declare type PoolType = 'ConstantProduct' | 'Stable' | 'Weighted' | 'LiquidityBootstrap';
export declare type UniquePoolId = number;
...
export declare type DexAssetPairing = [string, string, string];
...
export declare type PoolIdBaseForAddr = {
    contract: Addr;
} | {
    id: number;
};
