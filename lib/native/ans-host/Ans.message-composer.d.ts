...
import { PoolIdBaseForString, UniquePoolId, UncheckedContractEntry, UncheckedChannelEntry } from './Ans.types';
...
export declare class AnsMessageComposer implements AnsMessage {
    sender: string;
    contractAddress: string;
