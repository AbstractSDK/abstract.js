...
exports.cw20IcsQueryKeys = {
    ...
    address: function (contractAddress) {
        return [tslib_1.__assign(tslib_1.__assign({}, exports.cw20IcsQueryKeys.contract[0]), { address: contractAddress })];
    },
    port: function (contractAddress, args) {
        return [tslib_1.__assign(tslib_1.__assign({}, exports.cw20IcsQueryKeys.address(contractAddress)[0]), { method: 'port', args: args })];
    },
    listChannels: function (contractAddress, args) {
        return [tslib_1.__assign(tslib_1.__assign({}, exports.cw20IcsQueryKeys.address(contractAddress)[0]), { method: 'list_channels', args: args })];
    },
    channel: function (contractAddress, args) {
        return [tslib_1.__assign(tslib_1.__assign({}, exports.cw20IcsQueryKeys.address(contractAddress)[0]), { method: 'channel', args: args })];
    },
    config: function (contractAddress, args) {
        return [tslib_1.__assign(tslib_1.__assign({}, exports.cw20IcsQueryKeys.address(contractAddress)[0]), { method: 'config', args: args })];
    },
    admin: function (contractAddress, args) {
        return [tslib_1.__assign(tslib_1.__assign({}, exports.cw20IcsQueryKeys.address(contractAddress)[0]), { method: 'admin', args: args })];
    },
    allowed: function (contractAddress, args) {
        return [tslib_1.__assign(tslib_1.__assign({}, exports.cw20IcsQueryKeys.address(contractAddress)[0]), { method: 'allowed', args: args })];
    },
    listAllowed: function (contractAddress, args) {
        return [tslib_1.__assign(tslib_1.__assign({}, exports.cw20IcsQueryKeys.address(contractAddress)[0]), { method: 'list_allowed', args: args })];
    },
};
function useCw20IcsListAllowedQuery(_a) {
    var client = _a.client, args = _a.args, options = _a.options;
    return (0, react_query_1.useQuery)(exports.cw20IcsQueryKeys.listAllowed(client === null || client === void 0 ? void 0 : client.contractAddress, args), function () {
        return client
            ? client.listAllowed({
                limit: args.limit,
...
function useCw20IcsAllowedQuery(_a) {
    var client = _a.client, args = _a.args, options = _a.options;
    return (0, react_query_1.useQuery)(exports.cw20IcsQueryKeys.allowed(client === null || client === void 0 ? void 0 : client.contractAddress, args), function () {
        return client
            ? client.allowed({
...
function useCw20IcsAdminQuery(_a) {
...
function useCw20IcsConfigQuery(_a) {
    var client = _a.client, options = _a.options;
    return (0, react_query_1.useQuery)(exports.cw20IcsQueryKeys.config(client === null || client === void 0 ? void 0 : client.contractAddress), function () { return (client ? client.config() : Promise.reject(new Error('Invalid client'))); }, tslib_1.__assign(tslib_1.__assign({}, options), { enabled: !!client && ((options === null || options === void 0 ? void 0 : options.enabled) != undefined ? options.enabled : true) }));
}
exports.useCw20IcsConfigQuery = useCw20IcsConfigQuery;
function useCw20IcsChannelQuery(_a) {
    var client = _a.client, args = _a.args, options = _a.options;
    return (0, react_query_1.useQuery)(exports.cw20IcsQueryKeys.channel(client === null || client === void 0 ? void 0 : client.contractAddress, args), function () {
        return client
            ? client.channel({
                id: args.id,
            })
...
function useCw20IcsListChannelsQuery(_a) {
    var client = _a.client, options = _a.options;
    return (0, react_query_1.useQuery)(exports.cw20IcsQueryKeys.listChannels(client === null || client === void 0 ? void 0 : client.contractAddress), function () { return (client ? client.listChannels() : Promise.reject(new Error('Invalid client'))); }, tslib_1.__assign(tslib_1.__assign({}, options), { enabled: !!client && ((options === null || options === void 0 ? void 0 : options.enabled) != undefined ? options.enabled : true) }));
}
exports.useCw20IcsListChannelsQuery = useCw20IcsListChannelsQuery;
function useCw20IcsPortQuery(_a) {
    var client = _a.client, options = _a.options;
    return (0, react_query_1.useQuery)(exports.cw20IcsQueryKeys.port(client === null || client === void 0 ? void 0 : client.contractAddress), function () { return (client ? client.port() : Promise.reject(new Error('Invalid client'))); }, tslib_1.__assign(tslib_1.__assign({}, options), { enabled: !!client && ((options === null || options === void 0 ? void 0 : options.enabled) != undefined ? options.enabled : true) }));
}
