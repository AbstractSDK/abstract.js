...
import {
  ...
  PortResponse,
  TransferMsg,
} from '@abstract-money/abstract.js/lib/cw-plus/Cw20Ics.types'
import { Cw20IcsClient, Cw20IcsQueryClient } from '@abstract-money/abstract.js'
...
export const cw20IcsQueryKeys = {
  ...
  address: (contractAddress: string | undefined) =>
    [{ ...cw20IcsQueryKeys.contract[0], address: contractAddress }] as const,
  port: (contractAddress: string | undefined, args?: Record<string, unknown>) =>
    [{ ...cw20IcsQueryKeys.address(contractAddress)[0], method: 'port', args }] as const,
  listChannels: (contractAddress: string | undefined, args?: Record<string, unknown>) =>
    [{ ...cw20IcsQueryKeys.address(contractAddress)[0], method: 'list_channels', args }] as const,
  channel: (contractAddress: string | undefined, args?: Record<string, unknown>) =>
    [{ ...cw20IcsQueryKeys.address(contractAddress)[0], method: 'channel', args }] as const,
  config: (contractAddress: string | undefined, args?: Record<string, unknown>) =>
    [{ ...cw20IcsQueryKeys.address(contractAddress)[0], method: 'config', args }] as const,
  admin: (contractAddress: string | undefined, args?: Record<string, unknown>) =>
    [{ ...cw20IcsQueryKeys.address(contractAddress)[0], method: 'admin', args }] as const,
  allowed: (contractAddress: string | undefined, args?: Record<string, unknown>) =>
    [{ ...cw20IcsQueryKeys.address(contractAddress)[0], method: 'allowed', args }] as const,
  listAllowed: (contractAddress: string | undefined, args?: Record<string, unknown>) =>
    [{ ...cw20IcsQueryKeys.address(contractAddress)[0], method: 'list_allowed', args }] as const,
}
...
export interface Cw20IcsListAllowedQuery<TData>
  extends Cw20IcsReactQuery<ListAllowedResponse, TData> {
  args: {
    limit?: number
    startAfter?: string
  }
...
export function useCw20IcsListAllowedQuery<TData = ListAllowedResponse>({
  ...
  return useQuery<ListAllowedResponse, Error, TData>(
    cw20IcsQueryKeys.listAllowed(client?.contractAddress, args),
    () =>
      client
        ? client.listAllowed({
            limit: args.limit,
...
export function useCw20IcsAllowedQuery<TData = AllowedResponse>({
  ...
  return useQuery<AllowedResponse, Error, TData>(
    cw20IcsQueryKeys.allowed(client?.contractAddress, args),
    () =>
      client
        ? client.allowed({
...
export function useCw20IcsAdminQuery<TData = AdminResponse>({
  ...
  return useQuery<AdminResponse, Error, TData>(
    cw20IcsQueryKeys.admin(client?.contractAddress),
...
export function useCw20IcsConfigQuery<TData = ConfigResponse>({
  ...
  return useQuery<ConfigResponse, Error, TData>(
    cw20IcsQueryKeys.config(client?.contractAddress),
...
export function useCw20IcsChannelQuery<TData = ChannelResponse>({
  ...
  return useQuery<ChannelResponse, Error, TData>(
    cw20IcsQueryKeys.channel(client?.contractAddress, args),
    () =>
      client
        ? client.channel({
            id: args.id,
...
export interface Cw20IcsListChannelsQuery<TData>
  extends Cw20IcsReactQuery<ListChannelsResponse, TData> {}
export function useCw20IcsListChannelsQuery<TData = ListChannelsResponse>({
  ...
  return useQuery<ListChannelsResponse, Error, TData>(
    cw20IcsQueryKeys.listChannels(client?.contractAddress),
...
export function useCw20IcsPortQuery<TData = PortResponse>({
  ...
  return useQuery<PortResponse, Error, TData>(
    cw20IcsQueryKeys.port(client?.contractAddress),
