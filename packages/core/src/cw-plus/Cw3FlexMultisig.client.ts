...
export interface Cw3FlexMultisigReadOnlyInterface {
  ...
  proposal: ({
    proposalId,
  }: { proposalId: number }) => Promise<ProposalResponse>
  listProposals: ({
    limit,
    startAfter,
  }: {
  ...
  queryVote: ({
    proposalId,
    voter,
  }: { proposalId: number; voter: string }) => Promise<VoteResponse>
  listVotes: ({
    limit,
    proposalId,
    startAfter,
...
export class Cw3FlexMultisigQueryClient
  implements Cw3FlexMultisigReadOnlyInterface
{
...
export interface Cw3FlexMultisigInterface
  extends Cw3FlexMultisigReadOnlyInterface {
  contractAddress: string
  sender: string
  propose: (
    {
