...
export type DeploymentQuery = {
  ...
  chainInfo: { __typename?: 'ChainInfo'; rpcUrl: string }
}
        ...
        selections: [
          { kind: 'Field', name: { kind: 'Name', value: 'version' } },
          {
            ...
            selectionSet: {
              kind: 'SelectionSet',
              selections: [
                { kind: 'Field', name: { kind: 'Name', value: 'ansHost' } },
                { kind: 'Field', name: { kind: 'Name', value: 'registry' } },
                {
                  kind: 'Field',
                  name: { kind: 'Name', value: 'accountFactory' },
                },
              ],
            },
          },
          {
            kind: 'Field',
            name: { kind: 'Name', value: 'chainInfo' },
            arguments: [
              {
                kind: 'Argument',
                name: { kind: 'Name', value: 'chain' },
            ...
            selectionSet: {
              kind: 'SelectionSet',
              selections: [
                { kind: 'Field', name: { kind: 'Name', value: 'rpcUrl' } },
              ],
            },
          },
        ],
