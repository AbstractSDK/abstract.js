...
export interface AccountFactoryReadOnlyInterface {
  contractAddress: string
  config: () => Promise<ConfigResponse>
  ownership: () => Promise<OwnershipForString>
}
export class AccountFactoryQueryClient
  implements AccountFactoryReadOnlyInterface
{
...
export interface AccountFactoryInterface
  extends AccountFactoryReadOnlyInterface {
  contractAddress: string
  sender: string
  updateConfig: (
    {
...
export class AccountFactoryClient
  extends AccountFactoryQueryClient
  implements AccountFactoryInterface
{
