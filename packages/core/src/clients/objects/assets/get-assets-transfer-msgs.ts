...
import { NativeAsset, isNativeAsset } from './native-asset'
import { nativeAssetToCoin } from './native-asset-to-coin'

export function getAssetsTransfersMsgs<
...
>(assets: TAssets, sender: string, recipient: string) {
  ...
  cw20Assets.forEach((asset) => {
    msgs.push(getCW20AssetTransferMsg(asset, sender, recipient))
  })
