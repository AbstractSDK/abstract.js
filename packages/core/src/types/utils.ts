// Copied from https://github.com/wevm/wagmi/blob/main/packages/core/src/types/utils.ts#L10
...
export type SliceFirstFour<T extends readonly unknown[]> = T extends readonly [
  infer _,
  infer _,
  infer _,
  infer _,
