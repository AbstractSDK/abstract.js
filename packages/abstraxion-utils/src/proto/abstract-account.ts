...
export const AbstractAccount = {
  ...
  create<I extends Exact<DeepPartial<AbstractAccount>, I>>(
    base?: I,
  ): AbstractAccount {
    return AbstractAccount.fromPartial(base ?? ({} as any))
  },
  fromPartial<I extends Exact<DeepPartial<AbstractAccount>, I>>(
    object: I,
  ): AbstractAccount {
    const message = createBaseAbstractAccount()
...
export const NilPubKey = {
  ...
  fromPartial<I extends Exact<DeepPartial<NilPubKey>, I>>(
    object: I,
  ): NilPubKey {
    const message = createBaseNilPubKey()
