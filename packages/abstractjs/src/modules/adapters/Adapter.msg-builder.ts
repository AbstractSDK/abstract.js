...
import { ModuleExecuteMsgFactory, ModuleQueryMsgFactory } from '../Module.msg-factory'
...
export abstract class AdapterExecuteMsgFactory {
  ...
  static executeAdapter = <TAppMsg>({
    proxyAddress,
    request,
  }: CamelCasedProperties<AdapterRequestMsg<TAppMsg>>): AdapterExecuteMsg<TAppMsg> => {
...
export abstract class AdapterQueryMsgBuilder {
   ...
   * @param proxyAddress
   */
  static authorizedAddresses = (proxyAddress?: string): AdapterQueryMsg<never> => {
