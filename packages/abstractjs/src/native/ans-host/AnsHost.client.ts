...
export interface AnsHostReadOnlyInterface {
  ...
  assetInfos: ({ infos }: { infos: AssetInfoBaseForString[] }) => Promise<AssetsResponse>
  assetInfoList: ({
    filter,
    limit,
    startAfter,
  ...
  contracts: ({ entries }: { entries: ContractEntry[] }) => Promise<ContractsResponse>
  contractList: ({
    filter,
    limit,
    startAfter,
  ...
  channels: ({ entries }: { entries: ChannelEntry[] }) => Promise<ChannelsResponse>
  channelList: ({
    filter,
    limit,
    startAfter,
  ...
  pools: ({ pairings }: { pairings: DexAssetPairing[] }) => Promise<PoolsResponse>
  poolList: ({
    filter,
    limit,
    startAfter,
  ...
  poolMetadatas: ({ ids }: { ids: UniquePoolId[] }) => Promise<PoolMetadatasResponse>
  poolMetadataList: ({
    filter,
    limit,
    startAfter,
...
export class AnsHostQueryClient implements AnsHostReadOnlyInterface {
  ...
  assetInfos = async ({ infos }: { infos: AssetInfoBaseForString[] }): Promise<AssetsResponse> => {
    return this.client.queryContractSmart(this.contractAddress, {
      asset_infos: {
        infos,
      },
  ...
  contracts = async ({ entries }: { entries: ContractEntry[] }): Promise<ContractsResponse> => {
    return this.client.queryContractSmart(this.contractAddress, {
      contracts: {
        entries,
      },
  ...
  channels = async ({ entries }: { entries: ChannelEntry[] }): Promise<ChannelsResponse> => {
    return this.client.queryContractSmart(this.contractAddress, {
      channels: {
        entries,
      },
  ...
  pools = async ({ pairings }: { pairings: DexAssetPairing[] }): Promise<PoolsResponse> => {
    return this.client.queryContractSmart(this.contractAddress, {
      pools: {
        pairings,
      },
  ...
  poolMetadatas = async ({ ids }: { ids: UniquePoolId[] }): Promise<PoolMetadatasResponse> => {
    return this.client.queryContractSmart(this.contractAddress, {
      pool_metadatas: {
        ids,
      },
...
export class AnsHostClient extends AnsHostQueryClient implements AnsHostInterface {
