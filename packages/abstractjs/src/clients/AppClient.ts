...
import { AbstractAccountQueryClient, AbstractAccountClient } from './AbstractAccountClient'
 ...
 *
 */
export class AppQueryClient<TQueryMsg extends ContractMsg> implements IAppQueryClient<TQueryMsg> {
  accountQueryClient: AbstractAccountQueryClient
  moduleId: string
  _moduleAddress: string | undefined
...
export interface IAppClient<TQueryMsg extends ContractMsg, TExecMsg extends ContractMsg>
...
export class AppClient<TQueryMsg extends ContractMsg, TExecMsg extends ContractMsg>
  ...
  implements IAppClient<TQueryMsg, TExecMsg>
{
  ...
  public static fromQueryClient<TQueryMsg extends ContractMsg>(
    ...
    return new AppClient({ ...queryClient.accountQueryClient, ...queryClient, abstractClient })
  }
  ...
  _execute = async (
    ...
    const moduleMsg: AppExecuteMsg<TExecMsg> = AppExecuteMsgFactory.executeApp(msg)
