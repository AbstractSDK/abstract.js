...
type UpdateConfigMsg = Extract<
  ReturnType<typeof RegistryExecuteMsgBuilder.updateConfig>,
  { update_config: unknown }
>

type UpdateConfigMsgBuilderParameters = Parameters<
  typeof RegistryExecuteMsgBuilder.updateConfig
>[0]
...
function buildUpdateConfigMsg(
  ...
  return RegistryExecuteMsgBuilder.updateConfig(args) as UpdateConfigMsg
}
