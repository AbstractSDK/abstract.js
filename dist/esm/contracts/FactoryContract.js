...
var FactoryClient = /** @class */ (function (_super) {
    ...
    function FactoryClient(client, sender, contractAddress) {
        ...
        _this.receive = function (fee, memo, funds) {
        ...
        _this.updateConfig = function (_a, fee, memo, funds) {
            var admin = _a.admin, memoryContract = _a.memoryContract, moduleFactoryAddress = _a.moduleFactoryAddress, subscriptionAddress = _a.subscriptionAddress, versionControlContract = _a.versionControlContract;
            if (fee === void 0) { fee = "auto"; }
            return __awaiter(_this, void 0, void 0, function () {
        ...
        _this.createOs = function (_a, fee, memo, funds) {
            var description = _a.description, governance = _a.governance, link = _a.link, osName = _a.osName;
            if (fee === void 0) { fee = "auto"; }
            return __awaiter(_this, void 0, void 0, function () {
                return __generator(this, function (_b) {
                    switch (_b.label) {
