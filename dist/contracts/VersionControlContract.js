...
class VersionControlQueryClient {
    constructor(client, contractAddress) {
        ...
        Object.defineProperty(this, "codeIds", {
            ...
            configurable: true,
            writable: true,
            value: ({ iterLimit, lastModule, }) => __awaiter(this, void 0, void 0, function* () {
                return this.client.queryContractSmart(this.contractAddress, {
                    code_ids: {
        ...
        Object.defineProperty(this, "apiAddresses", {
            ...
            configurable: true,
            writable: true,
            value: ({ iterLimit, lastApiModule, }) => __awaiter(this, void 0, void 0, function* () {
                return this.client.queryContractSmart(this.contractAddress, {
                    api_addresses: {
                        iter_limit: iterLimit,
...
//# sourceMappingURL=VersionControlContract.js.map