...
function useCw3FlexMultisigListVotersQuery({ client, args, options }) {
    return (0, react_query_1.useQuery)(["cw3FlexMultisigListVoters", client === null || client === void 0 ? void 0 : client.contractAddress, JSON.stringify(args)], () => client ? client.listVoters({
        limit: args.limit,
...
function useCw3FlexMultisigVoterQuery({ client, args, options }) {
    return (0, react_query_1.useQuery)(["cw3FlexMultisigVoter", client === null || client === void 0 ? void 0 : client.contractAddress, JSON.stringify(args)], () => client ? client.voter({
...
function useCw3FlexMultisigListVotesQuery({ client, args, options }) {
    return (0, react_query_1.useQuery)(["cw3FlexMultisigListVotes", client === null || client === void 0 ? void 0 : client.contractAddress, JSON.stringify(args)], () => client ? client.listVotes({
        limit: args.limit,
...
function useCw3FlexMultisigVoteQuery({ client, args, options }) {
    return (0, react_query_1.useQuery)(["cw3FlexMultisigVote", client === null || client === void 0 ? void 0 : client.contractAddress, JSON.stringify(args)], () => client ? client.queryVote({
        proposalId: args.proposalId,
        voter: args.voter
    }) : undefined, Object.assign({ enabled: !!client && (options === null || options === void 0 ? void 0 : options.enabled) }, options));
}
...
function useCw3FlexMultisigReverseProposalsQuery({ client, args, options }) {
    return (0, react_query_1.useQuery)(["cw3FlexMultisigReverseProposals", client === null || client === void 0 ? void 0 : client.contractAddress, JSON.stringify(args)], () => client ? client.reverseProposals({
        limit: args.limit,
...
function useCw3FlexMultisigListProposalsQuery({ client, args, options }) {
    return (0, react_query_1.useQuery)(["cw3FlexMultisigListProposals", client === null || client === void 0 ? void 0 : client.contractAddress, JSON.stringify(args)], () => client ? client.listProposals({
        limit: args.limit,
        startAfter: args.startAfter
    }) : undefined, Object.assign({ enabled: !!client && (options === null || options === void 0 ? void 0 : options.enabled) }, options));
}
...
function useCw3FlexMultisigProposalQuery({ client, args, options }) {
    return (0, react_query_1.useQuery)(["cw3FlexMultisigProposal", client === null || client === void 0 ? void 0 : client.contractAddress, JSON.stringify(args)], () => client ? client.proposal({
        proposalId: args.proposalId
    }) : undefined, Object.assign({ enabled: !!client && (options === null || options === void 0 ? void 0 : options.enabled) }, options));
}
...
function useCw3FlexMultisigThresholdQuery({ client, options }) {
    return (0, react_query_1.useQuery)(["cw3FlexMultisigThreshold", client === null || client === void 0 ? void 0 : client.contractAddress], () => client ? client.threshold() : undefined, Object.assign({ enabled: !!client && (options === null || options === void 0 ? void 0 : options.enabled) }, options));
}
