...
function useCw4GroupMemberQuery({ client, args, options }) {
    return (0, react_query_1.useQuery)(['cw4GroupMember', client === null || client === void 0 ? void 0 : client.contractAddress, JSON.stringify(args)], () => client
        ? client.member({
            addr: args.addr,
...
function useCw4GroupListMembersQuery({ client, args, options }) {
    return (0, react_query_1.useQuery)(['cw4GroupListMembers', client === null || client === void 0 ? void 0 : client.contractAddress, JSON.stringify(args)], () => client
        ? client.listMembers({
            limit: args.limit,
