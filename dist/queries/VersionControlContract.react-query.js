...
function useVersionControlApiAddressesQuery({ client, args, options }) {
    return (0, react_query_1.useQuery)(["versionControlApiAddresses", client === null || client === void 0 ? void 0 : client.contractAddress, JSON.stringify(args)], () => client ? client.apiAddresses({
...
function useVersionControlCodeIdsQuery({ client, args, options }) {
    return (0, react_query_1.useQuery)(["versionControlCodeIds", client === null || client === void 0 ? void 0 : client.contractAddress, JSON.stringify(args)], () => client ? client.codeIds({
        iterLimit: args.iterLimit,
...
function useVersionControlApiAddressQuery({ client, args, options }) {
    return (0, react_query_1.useQuery)(["versionControlApiAddress", client === null || client === void 0 ? void 0 : client.contractAddress, JSON.stringify(args)], () => client ? client.apiAddress({
        module: args.module
    }) : Promise.reject(new Error("Invalid client")), Object.assign(Object.assign({}, options), { enabled: !!client && ((options === null || options === void 0 ? void 0 : options.enabled) != undefined ? options.enabled : true) }));
}
...
function useVersionControlCodeIdQuery({ client, args, options }) {
    return (0, react_query_1.useQuery)(["versionControlCodeId", client === null || client === void 0 ? void 0 : client.contractAddress, JSON.stringify(args)], () => client ? client.codeId({
        module: args.module
    }) : Promise.reject(new Error("Invalid client")), Object.assign(Object.assign({}, options), { enabled: !!client && ((options === null || options === void 0 ? void 0 : options.enabled) != undefined ? options.enabled : true) }));
}
...
function useVersionControlOsCoreQuery({ client, args, options }) {
    return (0, react_query_1.useQuery)(["versionControlOsCore", client === null || client === void 0 ? void 0 : client.contractAddress, JSON.stringify(args)], () => client ? client.osCore({
        osId: args.osId
    }) : Promise.reject(new Error("Invalid client")), Object.assign(Object.assign({}, options), { enabled: !!client && ((options === null || options === void 0 ? void 0 : options.enabled) != undefined ? options.enabled : true) }));
}
