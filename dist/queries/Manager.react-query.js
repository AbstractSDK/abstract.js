...
function useManagerInfoQuery({ client, options }) {
    return (0, react_query_1.useQuery)(['managerInfo', client === null || client === void 0 ? void 0 : client.contractAddress], () => (client ? client.info() : Promise.reject(new Error('Invalid client'))), Object.assign(Object.assign({}, options), { enabled: !!client && ((options === null || options === void 0 ? void 0 : options.enabled) != undefined ? options.enabled : true) }));
}
exports.useManagerInfoQuery = useManagerInfoQuery;
function useManagerConfigQuery({ client, options }) {
    return (0, react_query_1.useQuery)(['managerConfig', client === null || client === void 0 ? void 0 : client.contractAddress], () => (client ? client.config() : Promise.reject(new Error('Invalid client'))), Object.assign(Object.assign({}, options), { enabled: !!client && ((options === null || options === void 0 ? void 0 : options.enabled) != undefined ? options.enabled : true) }));
}
exports.useManagerConfigQuery = useManagerConfigQuery;
function useManagerModuleInfosQuery({ client, args, options }) {
    return (0, react_query_1.useQuery)(['managerModuleInfos', client === null || client === void 0 ? void 0 : client.contractAddress, JSON.stringify(args)], () => client
        ? client.moduleInfos({
...
function useManagerModuleAddressesQuery({ client, args, options, }) {
    return (0, react_query_1.useQuery)(['managerModuleAddresses', client === null || client === void 0 ? void 0 : client.contractAddress, JSON.stringify(args)], () => client
...
function useManagerModuleVersionsQuery({ client, args, options, }) {
    return (0, react_query_1.useQuery)(['managerModuleVersions', client === null || client === void 0 ? void 0 : client.contractAddress, JSON.stringify(args)], () => client
