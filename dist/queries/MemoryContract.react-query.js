...
function useMemoryAssetListQuery({ client, args, options }) {
    return (0, react_query_1.useQuery)(['memoryAssetList', client === null || client === void 0 ? void 0 : client.contractAddress, JSON.stringify(args)], () => client
        ? client.assetList({
...
function useMemoryContractListQuery({ client, args, options }) {
    return (0, react_query_1.useQuery)(['memoryContractList', client === null || client === void 0 ? void 0 : client.contractAddress, JSON.stringify(args)], () => client
        ? client.contractList({
            iterLimit: args.iterLimit,
...
function useMemoryContractsQuery({ client, args, options }) {
    return (0, react_query_1.useQuery)(['memoryContracts', client === null || client === void 0 ? void 0 : client.contractAddress, JSON.stringify(args)], () => client
        ? client.contracts({
            names: args.names,
        })
        : undefined, Object.assign({ enabled: !!client && (options === null || options === void 0 ? void 0 : options.enabled) }, options));
...
function useMemoryAssetsQuery({ client, args, options }) {
    return (0, react_query_1.useQuery)(['memoryAssets', client === null || client === void 0 ? void 0 : client.contractAddress, JSON.stringify(args)], () => client
        ? client.assets({
            names: args.names,
        })
        : undefined, Object.assign({ enabled: !!client && (options === null || options === void 0 ? void 0 : options.enabled) }, options));
