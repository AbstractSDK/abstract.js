...
function useProxyProxyAssetsQuery({ client, args, options }) {
    return (0, react_query_1.useQuery)(["proxyProxyAssets", client === null || client === void 0 ? void 0 : client.contractAddress, JSON.stringify(args)], () => client ? client.proxyAssets({
...
function useProxyProxyAssetConfigQuery({ client, args, options }) {
    return (0, react_query_1.useQuery)(["proxyProxyAssetConfig", client === null || client === void 0 ? void 0 : client.contractAddress, JSON.stringify(args)], () => client ? client.proxyAssetConfig({
...
function useProxyHoldingAmountQuery({ client, args, options }) {
    return (0, react_query_1.useQuery)(["proxyHoldingAmount", client === null || client === void 0 ? void 0 : client.contractAddress, JSON.stringify(args)], () => client ? client.holdingAmount({
        identifier: args.identifier
    }) : undefined, Object.assign(Object.assign({}, options), { enabled: !!client && ((options === null || options === void 0 ? void 0 : options.enabled) != undefined ? options.enabled : true) }));
}
exports.useProxyHoldingAmountQuery = useProxyHoldingAmountQuery;
function useProxyHoldingValueQuery({ client, args, options }) {
    return (0, react_query_1.useQuery)(["proxyHoldingValue", client === null || client === void 0 ? void 0 : client.contractAddress, JSON.stringify(args)], () => client ? client.holdingValue({
        identifier: args.identifier
    }) : undefined, Object.assign(Object.assign({}, options), { enabled: !!client && ((options === null || options === void 0 ? void 0 : options.enabled) != undefined ? options.enabled : true) }));
}
