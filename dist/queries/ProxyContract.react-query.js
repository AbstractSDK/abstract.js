...
function useProxyProxyAssetConfigQuery({ client, args, options, }) {
    return (0, react_query_1.useQuery)(['proxyProxyAssetConfig', client === null || client === void 0 ? void 0 : client.contractAddress], () => client
...
function useProxyHoldingAmountQuery({ client, args, options }) {
    return (0, react_query_1.useQuery)(['proxyHoldingAmount', client === null || client === void 0 ? void 0 : client.contractAddress], () => client
...
function useProxyHoldingValueQuery({ client, args, options }) {
    return (0, react_query_1.useQuery)(['proxyHoldingValue', client === null || client === void 0 ? void 0 : client.contractAddress], () => client
        ? client.holdingValue({
            identifier: args.identifier,
        })
        : undefined, Object.assign(Object.assign({}, options), { enabled: !!client && (options === null || options === void 0 ? void 0 : options.enabled) }));
