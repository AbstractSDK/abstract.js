...
function useManagerModuleInfosQuery({ client, args, options }) {
    return (0, react_query_1.useQuery)(['managerModuleInfos', client === null || client === void 0 ? void 0 : client.contractAddress], () => client
        ? client.moduleInfos({
...
function useManagerModuleAddressesQuery({ client, args, options, }) {
    return (0, react_query_1.useQuery)(['managerModuleAddresses', client === null || client === void 0 ? void 0 : client.contractAddress], () => client
...
function useManagerModuleVersionsQuery({ client, args, options, }) {
    return (0, react_query_1.useQuery)(['managerModuleVersions', client === null || client === void 0 ? void 0 : client.contractAddress], () => client
