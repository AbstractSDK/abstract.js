...
function useSubscriptionContributorStateQuery({ client, args, options, }) {
    return (0, react_query_1.useQuery)(['subscriptionContributorState', client === null || client === void 0 ? void 0 : client.contractAddress], () => client
...
function useSubscriptionSubscriberStateQuery({ client, args, options, }) {
    return (0, react_query_1.useQuery)(['subscriptionSubscriberState', client === null || client === void 0 ? void 0 : client.contractAddress], () => client
