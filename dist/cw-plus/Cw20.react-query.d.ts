...
export declare const cw20Queries: {
    balance: <TData = BalanceResponse>({ client, options, args, }: Cw20BalanceQuery<TData>) => UseQueryOptions<BalanceResponse, Error, TData, import("@tanstack/react-query").QueryKey>;
    tokenInfo: <TData_1 = TokenInfoResponse>({ client, options, }: Cw20TokenInfoQuery<TData_1>) => UseQueryOptions<TokenInfoResponse, Error, TData_1, import("@tanstack/react-query").QueryKey>;
    minter: <TData_2 = MinterResponse>({ client, options, }: Cw20MinterQuery<TData_2>) => UseQueryOptions<MinterResponse, Error, TData_2, import("@tanstack/react-query").QueryKey>;
    allowance: <TData_3 = AllowanceResponse>({ client, options, args, }: Cw20AllowanceQuery<TData_3>) => UseQueryOptions<AllowanceResponse, Error, TData_3, import("@tanstack/react-query").QueryKey>;
    allAllowances: <TData_4 = AllAllowancesResponse>({ client, options, args, }: Cw20AllAllowancesQuery<TData_4>) => UseQueryOptions<AllAllowancesResponse, Error, TData_4, import("@tanstack/react-query").QueryKey>;
    allAccounts: <TData_5 = AllAccountsResponse>({ client, options, args, }: Cw20AllAccountsQuery<TData_5>) => UseQueryOptions<AllAccountsResponse, Error, TData_5, import("@tanstack/react-query").QueryKey>;
    marketingInfo: <TData_6 = MarketingInfoResponse>({ client, options, }: Cw20MarketingInfoQuery<TData_6>) => UseQueryOptions<MarketingInfoResponse, Error, TData_6, import("@tanstack/react-query").QueryKey>;
    downloadLogo: <TData_7 = DownloadLogoResponse>({ client, options, }: Cw20DownloadLogoQuery<TData_7>) => UseQueryOptions<DownloadLogoResponse, Error, TData_7, import("@tanstack/react-query").QueryKey>;
};
