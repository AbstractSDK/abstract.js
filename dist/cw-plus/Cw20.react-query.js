...
exports.cw20QueryKeys = {
    ...
    address: (contractAddress) => [Object.assign(Object.assign({}, exports.cw20QueryKeys.contract[0]), { address: contractAddress })],
    balance: (contractAddress, args) => [Object.assign(Object.assign({}, exports.cw20QueryKeys.address(contractAddress)[0]), { method: 'balance', args })],
    tokenInfo: (contractAddress, args) => [Object.assign(Object.assign({}, exports.cw20QueryKeys.address(contractAddress)[0]), { method: 'token_info', args })],
    minter: (contractAddress, args) => [Object.assign(Object.assign({}, exports.cw20QueryKeys.address(contractAddress)[0]), { method: 'minter', args })],
    allowance: (contractAddress, args) => [Object.assign(Object.assign({}, exports.cw20QueryKeys.address(contractAddress)[0]), { method: 'allowance', args })],
    allAllowances: (contractAddress, args) => [Object.assign(Object.assign({}, exports.cw20QueryKeys.address(contractAddress)[0]), { method: 'all_allowances', args })],
    allAccounts: (contractAddress, args) => [Object.assign(Object.assign({}, exports.cw20QueryKeys.address(contractAddress)[0]), { method: 'all_accounts', args })],
    marketingInfo: (contractAddress, args) => [Object.assign(Object.assign({}, exports.cw20QueryKeys.address(contractAddress)[0]), { method: 'marketing_info', args })],
    downloadLogo: (contractAddress, args) => [Object.assign(Object.assign({}, exports.cw20QueryKeys.address(contractAddress)[0]), { method: 'download_logo', args })],
};
exports.cw20Queries = {
    balance: ({ client, options, args, }) => (Object.assign(Object.assign({ queryKey: exports.cw20QueryKeys.balance(client === null || client === void 0 ? void 0 : client.contractAddress, args), queryFn: () => client
            ? client.balance({
    ...
    tokenInfo: ({ client, options, }) => (Object.assign(Object.assign({ queryKey: exports.cw20QueryKeys.tokenInfo(client === null || client === void 0 ? void 0 : client.contractAddress), queryFn: () => (client ? client.tokenInfo() : Promise.reject(new Error('Invalid client'))) }, options), { enabled: !!client && ((options === null || options === void 0 ? void 0 : options.enabled) != undefined ? options.enabled : true) })),
    minter: ({ client, options, }) => (Object.assign(Object.assign({ queryKey: exports.cw20QueryKeys.minter(client === null || client === void 0 ? void 0 : client.contractAddress), queryFn: () => (client ? client.minter() : Promise.reject(new Error('Invalid client'))) }, options), { enabled: !!client && ((options === null || options === void 0 ? void 0 : options.enabled) != undefined ? options.enabled : true) })),
    allowance: ({ client, options, args, }) => (Object.assign(Object.assign({ queryKey: exports.cw20QueryKeys.allowance(client === null || client === void 0 ? void 0 : client.contractAddress, args), queryFn: () => client
            ? client.allowance({
                owner: args.owner,
                spender: args.spender,
            })
            : Promise.reject(new Error('Invalid client')) }, options), { enabled: !!client && ((options === null || options === void 0 ? void 0 : options.enabled) != undefined ? options.enabled : true) })),
    allAllowances: ({ client, options, args, }) => (Object.assign(Object.assign({ queryKey: exports.cw20QueryKeys.allAllowances(client === null || client === void 0 ? void 0 : client.contractAddress, args), queryFn: () => client
            ...
            : Promise.reject(new Error('Invalid client')) }, options), { enabled: !!client && ((options === null || options === void 0 ? void 0 : options.enabled) != undefined ? options.enabled : true) })),
    allAccounts: ({ client, options, args, }) => (Object.assign(Object.assign({ queryKey: exports.cw20QueryKeys.allAccounts(client === null || client === void 0 ? void 0 : client.contractAddress, args), queryFn: () => client
            ? client.allAccounts({
                limit: args.limit,
                startAfter: args.startAfter,
            })
            : Promise.reject(new Error('Invalid client')) }, options), { enabled: !!client && ((options === null || options === void 0 ? void 0 : options.enabled) != undefined ? options.enabled : true) })),
    marketingInfo: ({ client, options, }) => (Object.assign(Object.assign({ queryKey: exports.cw20QueryKeys.marketingInfo(client === null || client === void 0 ? void 0 : client.contractAddress), queryFn: () => (client ? client.marketingInfo() : Promise.reject(new Error('Invalid client'))) }, options), { enabled: !!client && ((options === null || options === void 0 ? void 0 : options.enabled) != undefined ? options.enabled : true) })),
    downloadLogo: ({ client, options, }) => (Object.assign(Object.assign({ queryKey: exports.cw20QueryKeys.downloadLogo(client === null || client === void 0 ? void 0 : client.contractAddress), queryFn: () => (client ? client.downloadLogo() : Promise.reject(new Error('Invalid client'))) }, options), { enabled: !!client && ((options === null || options === void 0 ? void 0 : options.enabled) != undefined ? options.enabled : true) })),
};
function useCw20DownloadLogoQuery({ client, options, }) {
    return (0, react_query_1.useQuery)(exports.cw20QueryKeys.downloadLogo(client === null || client === void 0 ? void 0 : client.contractAddress), () => (client ? client.downloadLogo() : Promise.reject(new Error('Invalid client'))), Object.assign(Object.assign({}, options), { enabled: !!client && ((options === null || options === void 0 ? void 0 : options.enabled) != undefined ? options.enabled : true) }));
}
exports.useCw20DownloadLogoQuery = useCw20DownloadLogoQuery;
function useCw20MarketingInfoQuery({ client, options, }) {
    return (0, react_query_1.useQuery)(exports.cw20QueryKeys.marketingInfo(client === null || client === void 0 ? void 0 : client.contractAddress), () => (client ? client.marketingInfo() : Promise.reject(new Error('Invalid client'))), Object.assign(Object.assign({}, options), { enabled: !!client && ((options === null || options === void 0 ? void 0 : options.enabled) != undefined ? options.enabled : true) }));
}
exports.useCw20MarketingInfoQuery = useCw20MarketingInfoQuery;
function useCw20AllAccountsQuery({ client, args, options, }) {
    return (0, react_query_1.useQuery)(exports.cw20QueryKeys.allAccounts(client === null || client === void 0 ? void 0 : client.contractAddress, args), () => client
        ? client.allAccounts({
            limit: args.limit,
            startAfter: args.startAfter,
        })
...
function useCw20AllAllowancesQuery({ client, args, options, }) {
    return (0, react_query_1.useQuery)(exports.cw20QueryKeys.allAllowances(client === null || client === void 0 ? void 0 : client.contractAddress, args), () => client
        ? client.allAllowances({
            limit: args.limit,
            owner: args.owner,
            startAfter: args.startAfter,
...
function useCw20AllowanceQuery({ client, args, options, }) {
    return (0, react_query_1.useQuery)(exports.cw20QueryKeys.allowance(client === null || client === void 0 ? void 0 : client.contractAddress, args), () => client
        ? client.allowance({
            owner: args.owner,
            spender: args.spender,
        })
...
function useCw20MinterQuery({ client, options, }) {
    return (0, react_query_1.useQuery)(exports.cw20QueryKeys.minter(client === null || client === void 0 ? void 0 : client.contractAddress), () => (client ? client.minter() : Promise.reject(new Error('Invalid client'))), Object.assign(Object.assign({}, options), { enabled: !!client && ((options === null || options === void 0 ? void 0 : options.enabled) != undefined ? options.enabled : true) }));
}
exports.useCw20MinterQuery = useCw20MinterQuery;
function useCw20TokenInfoQuery({ client, options, }) {
    return (0, react_query_1.useQuery)(exports.cw20QueryKeys.tokenInfo(client === null || client === void 0 ? void 0 : client.contractAddress), () => (client ? client.tokenInfo() : Promise.reject(new Error('Invalid client'))), Object.assign(Object.assign({}, options), { enabled: !!client && ((options === null || options === void 0 ? void 0 : options.enabled) != undefined ? options.enabled : true) }));
}
exports.useCw20TokenInfoQuery = useCw20TokenInfoQuery;
function useCw20BalanceQuery({ client, args, options, }) {
    return (0, react_query_1.useQuery)(exports.cw20QueryKeys.balance(client === null || client === void 0 ? void 0 : client.contractAddress, args), () => client
        ? client.balance({
            address: args.address,
        })
        : Promise.reject(new Error('Invalid client')), Object.assign(Object.assign({}, options), { enabled: !!client && ((options === null || options === void 0 ? void 0 : options.enabled) != undefined ? options.enabled : true) }));
...
//# sourceMappingURL=Cw20.react-query.js.map