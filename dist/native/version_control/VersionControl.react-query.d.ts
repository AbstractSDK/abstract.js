...
export declare const versionControlQueries: {
    osCore: <TData = OsCoreResponse>({ client, args, options, }: VersionControlOsCoreQuery<TData>) => UseQueryOptions<OsCoreResponse, Error, TData, import("@tanstack/react-query").QueryKey>;
    module: <TData_1 = ModuleResponse>({ client, args, options, }: VersionControlModuleQuery<TData_1>) => UseQueryOptions<ModuleResponse, Error, TData_1, import("@tanstack/react-query").QueryKey>;
    ...
    modules: <TData_3 = ModulesResponse>({ client, args, options, }: VersionControlModulesQuery<TData_3>) => UseQueryOptions<ModulesResponse, Error, TData_3, import("@tanstack/react-query").QueryKey>;
};
