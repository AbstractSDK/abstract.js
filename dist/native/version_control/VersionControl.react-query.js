...
exports.versionControlQueries = {
    osCore: ({ client, args, options, }) => (Object.assign(Object.assign({ queryKey: exports.versionControlQueryKeys.osCore(client === null || client === void 0 ? void 0 : client.contractAddress, args), queryFn: () => client
            ? client.osCore({
                osId: args.osId,
            })
    ...
    module: ({ client, args, options, }) => (Object.assign(Object.assign({ queryKey: exports.versionControlQueryKeys.module(client === null || client === void 0 ? void 0 : client.contractAddress, args), queryFn: () => client
            ? client.module({
                module: args.module,
            })
            : Promise.reject(new Error('Invalid client')) }, options), { enabled: !!client && ((options === null || options === void 0 ? void 0 : options.enabled) != undefined ? options.enabled : true) })),
    ...
    modules: ({ client, args, options, }) => (Object.assign(Object.assign({ queryKey: exports.versionControlQueryKeys.modules(client === null || client === void 0 ? void 0 : client.contractAddress, args), queryFn: () => client
            ? client.modules({
