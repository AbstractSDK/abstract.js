...
exports.proxyQueries = {
    ...
    holdingValue: ({ client, options, args, }) => (Object.assign(Object.assign({ queryKey: exports.proxyQueryKeys.holdingValue(client === null || client === void 0 ? void 0 : client.contractAddress, args), queryFn: () => client
            ? client.holdingValue({
    ...
    holdingAmount: ({ client, options, args, }) => (Object.assign(Object.assign({ queryKey: exports.proxyQueryKeys.holdingAmount(client === null || client === void 0 ? void 0 : client.contractAddress, args), queryFn: () => client
            ? client.holdingAmount({
                identifier: args.identifier,
            })
            : Promise.reject(new Error('Invalid client')) }, options), { enabled: !!client && ((options === null || options === void 0 ? void 0 : options.enabled) != undefined ? options.enabled : true) })),
    assetConfig: ({ client, options, args, }) => (Object.assign(Object.assign({ queryKey: exports.proxyQueryKeys.assetConfig(client === null || client === void 0 ? void 0 : client.contractAddress, args), queryFn: () => client
            ? client.assetConfig({
                identifier: args.identifier,
            })
            : Promise.reject(new Error('Invalid client')) }, options), { enabled: !!client && ((options === null || options === void 0 ? void 0 : options.enabled) != undefined ? options.enabled : true) })),
    assets: ({ client, options, args, }) => (Object.assign(Object.assign({ queryKey: exports.proxyQueryKeys.assets(client === null || client === void 0 ? void 0 : client.contractAddress, args), queryFn: () => client
            ? client.assets({
