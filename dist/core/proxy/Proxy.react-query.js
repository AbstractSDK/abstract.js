...
exports.proxyQueryKeys = {
    ...
    tokenValue: (contractAddress, args) => [Object.assign(Object.assign({}, exports.proxyQueryKeys.address(contractAddress)[0]), { method: 'token_value', args })],
...
exports.proxyQueries = {
    ...
    tokenValue: ({ client, args, options, }) => (Object.assign(Object.assign({ queryKey: exports.proxyQueryKeys.tokenValue(client === null || client === void 0 ? void 0 : client.contractAddress, args), queryFn: () => client
            ? client.tokenValue({
                amount: args.amount,
    ...
    holdingValue: ({ client, args, options, }) => (Object.assign(Object.assign({ queryKey: exports.proxyQueryKeys.holdingValue(client === null || client === void 0 ? void 0 : client.contractAddress, args), queryFn: () => client
            ? client.holdingValue({
                identifier: args.identifier,
            })
            : Promise.reject(new Error('Invalid client')) }, options), { enabled: !!client && ((options === null || options === void 0 ? void 0 : options.enabled) != undefined ? options.enabled : true) })),
    holdingAmount: ({ client, args, options, }) => (Object.assign(Object.assign({ queryKey: exports.proxyQueryKeys.holdingAmount(client === null || client === void 0 ? void 0 : client.contractAddress, args), queryFn: () => client
            ? client.holdingAmount({
                identifier: args.identifier,
            })
            : Promise.reject(new Error('Invalid client')) }, options), { enabled: !!client && ((options === null || options === void 0 ? void 0 : options.enabled) != undefined ? options.enabled : true) })),
    assetConfig: ({ client, args, options, }) => (Object.assign(Object.assign({ queryKey: exports.proxyQueryKeys.assetConfig(client === null || client === void 0 ? void 0 : client.contractAddress, args), queryFn: () => client
            ? client.assetConfig({
                identifier: args.identifier,
            })
            : Promise.reject(new Error('Invalid client')) }, options), { enabled: !!client && ((options === null || options === void 0 ? void 0 : options.enabled) != undefined ? options.enabled : true) })),
    assets: ({ client, args, options, }) => (Object.assign(Object.assign({ queryKey: exports.proxyQueryKeys.assets(client === null || client === void 0 ? void 0 : client.contractAddress, args), queryFn: () => client
            ? client.assets({
...
function useProxyAssetsQuery({ client, args, options, }) {
    return (0, react_query_1.useQuery)(exports.proxyQueryKeys.assets(client === null || client === void 0 ? void 0 : client.contractAddress, args), () => client
        ? client.assets({
            pageSize: args.pageSize,
            pageToken: args.pageToken,
        })
...
function useProxyAssetConfigQuery({ client, args, options, }) {
    return (0, react_query_1.useQuery)(exports.proxyQueryKeys.assetConfig(client === null || client === void 0 ? void 0 : client.contractAddress, args), () => client
        ? client.assetConfig({
            identifier: args.identifier,
        })
        : Promise.reject(new Error('Invalid client')), Object.assign(Object.assign({}, options), { enabled: !!client && ((options === null || options === void 0 ? void 0 : options.enabled) != undefined ? options.enabled : true) }));
...
function useProxyTokenValueQuery({ client, args, options, }) {
    return (0, react_query_1.useQuery)(exports.proxyQueryKeys.tokenValue(client === null || client === void 0 ? void 0 : client.contractAddress, args), () => client
        ? client.tokenValue({
            amount: args.amount,
            identifier: args.identifier,
        })
...
function useProxyIbcActionMutation(options) {
    return (0, react_query_1.useMutation)(({ client, msg, args: { fee, memo, funds } = {} }) => client.ibcAction(msg, fee, memo, funds), options);
}
