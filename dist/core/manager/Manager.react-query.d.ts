...
export declare const managerQueries: {
    moduleVersions: <TData = ModuleVersionsResponse>({ client, args, options, }: ManagerModuleVersionsQuery<TData>) => UseQueryOptions<ModuleVersionsResponse, Error, TData, import("@tanstack/react-query").QueryKey>;
    moduleAddresses: <TData_1 = ModuleAddressesResponse>({ client, args, options, }: ManagerModuleAddressesQuery<TData_1>) => UseQueryOptions<ModuleAddressesResponse, Error, TData_1, import("@tanstack/react-query").QueryKey>;
    moduleInfos: <TData_2 = ModuleInfosResponse>({ client, args, options, }: ManagerModuleInfosQuery<TData_2>) => UseQueryOptions<ModuleInfosResponse, Error, TData_2, import("@tanstack/react-query").QueryKey>;
    config: <TData_3 = ConfigResponse>({ client, options, }: ManagerConfigQuery<TData_3>) => UseQueryOptions<ConfigResponse, Error, TData_3, import("@tanstack/react-query").QueryKey>;
    info: <TData_4 = InfoResponse>({ client, options, }: ManagerInfoQuery<TData_4>) => UseQueryOptions<InfoResponse, Error, TData_4, import("@tanstack/react-query").QueryKey>;
};
...
export declare function useManagerEnableIBCMutation(options?: Omit<UseMutationOptions<ExecuteResult, Error, ManagerEnableIBCMutation>, 'mutationFn'>): import("@tanstack/react-query").UseMutationResult<ExecuteResult, Error, ManagerEnableIBCMutation, unknown>;
...
export declare function useManagerSetRootMutation(options?: Omit<UseMutationOptions<ExecuteResult, Error, ManagerSetRootMutation>, 'mutationFn'>): import("@tanstack/react-query").UseMutationResult<ExecuteResult, Error, ManagerSetRootMutation, unknown>;
...
export declare function useManagerInstallModuleMutation(options?: Omit<UseMutationOptions<ExecuteResult, Error, ManagerInstallModuleMutation>, 'mutationFn'>): import("@tanstack/react-query").UseMutationResult<ExecuteResult, Error, ManagerInstallModuleMutation, unknown>;
...
export declare function useManagerUpdateModuleAddressesMutation(options?: Omit<UseMutationOptions<ExecuteResult, Error, ManagerUpdateModuleAddressesMutation>, 'mutationFn'>): import("@tanstack/react-query").UseMutationResult<ExecuteResult, Error, ManagerUpdateModuleAddressesMutation, unknown>;
