...
export declare const managerQueries: {
    moduleVersions: <TData = ModuleVersionsResponse>({ client, options, args }: ManagerModuleVersionsQuery<TData>) => UseQueryOptions<ModuleVersionsResponse, Error, TData, import("@tanstack/react-query").QueryKey>;
    moduleAddresses: <TData_1 = ModuleAddressesResponse>({ client, options, args }: ManagerModuleAddressesQuery<TData_1>) => UseQueryOptions<ModuleAddressesResponse, Error, TData_1, import("@tanstack/react-query").QueryKey>;
    moduleInfos: <TData_2 = ModuleInfosResponse>({ client, options, args }: ManagerModuleInfosQuery<TData_2>) => UseQueryOptions<ModuleInfosResponse, Error, TData_2, import("@tanstack/react-query").QueryKey>;
