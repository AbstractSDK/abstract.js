...
exports.managerQueries = {
    moduleVersions: ({ client, args, options, }) => (Object.assign(Object.assign({ queryKey: exports.managerQueryKeys.moduleVersions(client === null || client === void 0 ? void 0 : client.contractAddress, args), queryFn: () => client
    ...
    moduleAddresses: ({ client, args, options, }) => (Object.assign(Object.assign({ queryKey: exports.managerQueryKeys.moduleAddresses(client === null || client === void 0 ? void 0 : client.contractAddress, args), queryFn: () => client
            ? client.moduleAddresses({
                ids: args.ids,
            })
            : Promise.reject(new Error('Invalid client')) }, options), { enabled: !!client && ((options === null || options === void 0 ? void 0 : options.enabled) != undefined ? options.enabled : true) })),
    moduleInfos: ({ client, args, options, }) => (Object.assign(Object.assign({ queryKey: exports.managerQueryKeys.moduleInfos(client === null || client === void 0 ? void 0 : client.contractAddress, args), queryFn: () => client
            ? client.moduleInfos({
...
function useManagerEnableIBCMutation(options) {
    return (0, react_query_1.useMutation)(({ client, msg, args: { fee, memo, funds } = {} }) => client.enableIBC(msg, fee, memo, funds), options);
}
...
function useManagerInstallModuleMutation(options) {
    return (0, react_query_1.useMutation)(({ client, msg, args: { fee, memo, funds } = {} }) => client.installModule(msg, fee, memo, funds), options);
}
